<?php  return array (
  ...
  array (
    ...
    'content' => '    [[!pdoResources?
          ...
          &tpl=`@INLINE <li class="tags-list__item"> <a href="[[~20]]?tag=[[+alias]]" class="tags-list__item__link">[[+tag]] ( [[+countTags]] )</a> </li>`
    ]]',
    'richtext' => 0,
    'template' => 3,
    'menuindex' => 0,
...
<body>
    <div class="wrapper">
          ...
          <div class="top-header__wrap">
            ...
            <nav class="main-navigation">
                <ul class="nav-list">
                    ...
                    <li class="nav-list__nav-item"><a href="/poleznaya-informacziya/"  class="nav-list__nav-item__nav-link">Полезная информация</a></li><li class="nav-list__nav-item"><a href="/poslednie-akczii/"  class="nav-list__nav-item__nav-link">Последние акции</a></li><li class="nav-list__nav-item"><a href="/o-servise"  class="nav-list__nav-item__nav-link">О сервисе</a></li><li class="nav-list__nav-item"><a href="/novosty/"  class="nav-list__nav-item__nav-link">Новости</a></li>            
                </ul>
            </nav>
          </div>
        </div>
        <div class="bottom-header">
          <div class="search-form-wrap">
            [[!SimpleSearchForm? &landing=`1` &tpl=`search_form`]]
          </div>
        </div>
      </header>
    ...
    <!-- pdoPage pdoResources -->
    
    [[!pdoPage?
    	&parents=`3,6`
    	&tpl=`home_article_tpl`
    	&limit=`3`
    	&sortby=`publishedon`
    	&sortdir=`desc`
    	&includeTVs=`thumb,image`
    	&IincludeContent=`1`
    	&hideContainers = `1`
        &tplPageWrapper =`@INLINE [[+prev]][[+pages]][[+next]]`
        &tplPage = `@INLINE <a href="[[+href]]" class="pagenavi-post__page">[[+pageNo]]</a>`
        &tplPageActive = `@INLINE <a href="[[+href]]" class="pagenavi-post__current">[[+pageNo]]</a>`
        ...
        &tplPagePrev = `@INLINE <a href="[[+href]]" class="pagenavi-post__prev-postlink"><i class="icon icon-angle-double-left"></i></a>`
        &tplPageNext = `@INLINE <a href="[[+href]]" class="pagenavi-post__next-postlink"><i class="icon icon-angle-double-right"></i></a>`
        &tplPageSkip = 	`@INLINE <a href="#" class="pagenavi-post__page">..</a>`
        &tplPageFirstEmpty = `@INLINE <a href="[[+href]]" class="pagenavi-post__page">[[+pageNo]]</a>`
        &tplPageLastEmpty =	`@INLINE <a href="[[+href]]" class="pagenavi-post__page">[[+pageNo]]</a>`
        &tplPagePrevEmpty =	`@INLINE <a href="[[+href]]" class="pagenavi-post__page">[[+pageNo]]</a>`
        &tplPageNextEmpty =	`@INLINE <a href="[[+href]]" class="pagenavi-post__page">[[+pageNo]]</a>`
    ]]
    ...
    <div class="sidebar-item__content">
            ...
            <ul class="category-list"><li class="category-list__item">
                    <a href="" class="category-list__item__link">Вылеты из столиц12</a><ul class="category-list__inner"><li class="category-list__item"><a href="moskva-capital/"  class="category-list__item__link">Москва</a></li><li class="category-list__item"><a href="sankt-peterburg-capital/"  class="category-list__item__link">Санкт-Петербург</a></li></ul></li><li class="category-list__item">
                    <a href="" class="category-list__item__link">Вылеты из регионов13</a><ul class="category-list__inner"><li class="category-list__item"><a href="moskva-region/"  class="category-list__item__link">Москва</a></li><li class="category-list__item"><a href="sankt-peterburg-region/"  class="category-list__item__link">Санкт-Петербург</a></li></ul></li></ul>
        ...
        <div class="content-footer">
          <div class="bottom-menu">
              <ul class="b-menu__list"><li class="b-menu__list__item"><a href="/"  class="b-menu__list__item__link">Главная</a></li><li class="b-menu__list__item"><a href="poleznaya-informacziya/"  class="b-menu__list__item__link">Полезная информация</a></li><li class="b-menu__list__item"><a href="poslednie-akczii/"  class="b-menu__list__item__link">Последние акции</a></li><li class="b-menu__list__item"><a href="o-servise"  class="b-menu__list__item__link">О сервисе</a></li></ul>            
          </div>
  ...
  'elementCache' => 
  array (
    '[[$head]]' => '    <title>Главная | Туристик</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
    <link rel="stylesheet" href="/assets/template/css/libs.min.css">
...
',
    '[[%pdopage_first]]' => 'pdopage_first',
    '[[%pdopage_last]]' => 'pdopage_last',
    '[[$home_article]]' => '<div class="content">
    <h1 class="title-page">Последние новости и акции из мира туризма</h1>
    <!-- pdoPage pdoResources -->
    ...
    <script src="assets/template/js/main.js"></script>
',
    '[[pdoResources?tpl=`home_article_tpl`&returnIds=``&showLog=``&fastMode=``&sortby=`publishedon`&sortbyTV=``&sortbyTVType=``&sortdir=`desc`&sortdirTV=`ASC`&limit=`3`&offset=`0`&depth=`10`&outputSeparator=`
`&toPlaceholder=``&parents=`3,6`&includeContent=``&includeTVs=`thumb,image`&prepareTVs=`1`&processTVs=``&tvPrefix=`tv.`&tvFilters=``&tvFiltersAndDelimiter=`,`&tvFiltersOrDelimiter=`||`&where=``&showUnpublished=``&showDeleted=``&showHidden=`1`&hideContainers=`1`&context=``&idx=``&first=``&last=``&tplFirst=``&tplLast=``&tplOdd=``&tplWrapper=``&wrapIfEmpty=``&totalVar=`page.total`&resources=``&tplCondition=``&tplOperator=`==`&conditionalTpls=``&select=``&toSeparatePlaceholders=``&loadModels=``&scheme=``&useWeblinkUrl=``&plPrefix=``&maxLimit=`100`&page=`1`&pageVarKey=`page`&pageLimit=`5`&element=`pdoResources`&pageNavVar=`page.nav`&pageCountVar=`pageCount`&pageLinkScheme=``&tplPage=`@INLINE <a href="[[+href]]" class="pagenavi-post__page">[[+pageNo]]</a>`&tplPageWrapper=`@INLINE [[+prev]][[+pages]][[+next]]`&tplPageActive=`@INLINE <a href="[[+href]]" class="pagenavi-post__current">[[+pageNo]]</a>`&tplPageFirst=`@INLINE <li class="control"><a href="[[+href]]">pdopage_first</a></li>`&tplPageLast=`@INLINE <li class="control"><a href="[[+href]]">pdopage_last</a></li>`&tplPagePrev=`@INLINE <a href="[[+href]]" class="pagenavi-post__prev-postlink"><i class="icon icon-angle-double-left"></i></a>`&tplPageNext=`@INLINE <a href="[[+href]]" class="pagenavi-post__next-postlink"><i class="icon icon-angle-double-right"></i></a>`&tplPageSkip=`@INLINE <a href="#" class="pagenavi-post__page">..</a>`&tplPageFirstEmpty=`@INLINE <a href="[[+href]]" class="pagenavi-post__page">[[+pageNo]]</a>`&tplPageLastEmpty=`@INLINE <a href="[[+href]]" class="pagenavi-post__page">[[+pageNo]]</a>`&tplPagePrevEmpty=`@INLINE <a href="[[+href]]" class="pagenavi-post__page">[[+pageNo]]</a>`&tplPageNextEmpty=`@INLINE <a href="[[+href]]" class="pagenavi-post__page">[[+pageNo]]</a>`&cache=``&cacheTime=`3600`&cacheAnonymous=``&ajax=``&ajaxMode=``&ajaxElemWrapper=`#pdopage`&ajaxElemRows=`#pdopage .rows`&ajaxElemPagination=`#pdopage .pagination`&ajaxElemLink=`#pdopage .pagination a`&ajaxElemMore=`#pdopage .btn-more`&ajaxTplMore=`@INLINE <button class="btn btn-default btn-more">[[%pdopage_more]]</button>`&ajaxHistory=``&setMeta=`1`&strictMode=`1`&IincludeContent=`1`&request=`52aef9836b72d06f954be0d1646b70ef`]]' => '<!-- post-mini-->
<div class="post-wrap">
    <div class="post-thumbnail"><img src="assets/template/img/post_thumb/thumb_2.jpg" alt="Image поста" class="post-thumbnail__image"></div>
    <div class="post-content">
        <div class="post-content__post-info">
            <div class="post-date">29.07.2019</div>
        </div>
        <div class="post-content__post-text">
            <div class="post-title">
                В Германии завершается распродажа железнодорожных билетов от 19 евро -- ( 9 )
            </div>
            <p>
                Идейные соображения высшего порядка, а также сложившаяся структура организации обеспечивает широкому кругу (специалистов) участие в формировании дальнейших направлений развития...
            </p>
        </div>
        <div class="post-content__post-control"><a href="article-airfrance" class="btn-read-post">Читать далее >></a></div>
    </div>
</div>
<!-- post-mini_end-->
<!-- post-mini-->
<div class="post-wrap">
    <div class="post-thumbnail"><img src="assets/template/img/post_thumb/thumb_3.jpg" alt="Image поста" class="post-thumbnail__image"></div>
    <div class="post-content">
        <div class="post-content__post-info">
            <div class="post-date">29.07.2019</div>
        </div>
        <div class="post-content__post-text">
            <div class="post-title">
                В Германии завершается распродажа железнодорожных билетов от 19 евро (3) -- ( 8 )
            </div>
            <p>
                Идейные соображения высшего порядка, а также сложившаяся структура организации обеспечивает широкому кругу (специалистов) участие в формировании дальнейших направлений развития...
            </p>
        </div>
        <div class="post-content__post-control"><a href="article-riga" class="btn-read-post">Читать далее >></a></div>
    </div>
</div>
<!-- post-mini_end-->
<!-- post-mini-->
<div class="post-wrap">
    <div class="post-thumbnail"><img src="assets/template/img/post_thumb/thumb_1.jpg" alt="Image поста" class="post-thumbnail__image"></div>
    <div class="post-content">
        <div class="post-content__post-info">
            <div class="post-date">20.04.2017</div>
        </div>
        <div class="post-content__post-text">
            <div class="post-title">
                В Германии завершается распродажа железнодорожных билетов от 19 евро -- ( 10 )
            </div>
            <p>
                Идейные соображения высшего порядка, а также сложившаяся структура организации обеспечивает широкому кругу (специалистов) участие в формировании дальнейших направлений развития...
        ...
        <div class="post-content__post-control"><a href="article-germany" class="btn-read-post">Читать далее >></a></div>
    </div>
</div>
<!-- post-mini_end-->',
  ),
